...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/MDFInternationalization/MDFInternationalization.framework"
  install_framework "${PODS_ROOT}/MDFTextAccessibility/MDFTextAccessibility.framework"
  install_framework "${PODS_ROOT}/MaterialComponents/MaterialComponents.framework"
